        ...
        child: Column(
          ...
          children: [
            const HighlightCard(
              ...
              subtitle: 'The app code is wired for Firebase Auth and Firestore, but this build is missing Firebase project configuration.',
              primaryValue: 'Next step',
              secondaryValue: 'Run FlutterFire configuration and add your platform Firebase files.',
            ...
            AppSectionCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('What you need to do', style: Theme.of(context).textTheme.titleMedium),
                  const SizedBox(height: 10),
                  const Text('1. Create a Firebase project.'),
                  const Text('2. Enable Email/Password in Firebase Authentication.'),
                  ...
                  Text('Current error', style: Theme.of(context).textTheme.titleSmall),
